                    ...
                    <Box key={i} className={classes.Comments}>
                      <div className={classes.MainComment}>
                        <div className={classes.content}>
                          <Avatar alt={cname} src={getFullUrl(cProfile)} />
                          {editComment !== comment_id ? (
                            <Box className={classes.commentDetail}>
                              ...
                              {!iscommentlike ? (
                                <IconButton
                                  onClick={() => CommentLikeHandle(comment_id)}>
                                  <StyledBadge
                              ...
                              <IconButton
                                aria-label="Example"
                                onClick={() => EditComment(comment_id, saying)}>
                                <EditIcon fontSize="small" />
                              </IconButton>
                              <IconButton
                                aria-label="Example"
                                onClick={() => CommentDelete(comment_id)}>
                            ...
                            <Box
                              ...
                              <div style={{ marginRight: "8px" }}>
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    updateComment(postid, comment_id)
                                  }
                                  type="submit"
                                  variant="outlined"
