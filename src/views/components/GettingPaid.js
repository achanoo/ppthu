                            ...
                            <Grid container direction="row" spacing={3}>
                                <Grid item container>
                                    ...
                                    <Grid xs={12} sm={8} md={8}>
                                        ...
                                        >
                                            <FormControlLabel value="is" control={<Radio sx={{ fontWeight : 'bold'}}/>} label="Monthly" />
                                            <div className="subtitle" style={{marginLeft: '30px', marginBottom: '10px'}}>Charge my patrons at the start of every month.</div>
                                        </RadioGroup>
                                        
                                        <Checkbox {...label} disabled style={{marginLeft: '20px'}} /> Charge Patrons up front <br/>
                                        
                                        <Button variant="contained" color="info" style={{borderRadius : '24px', padding : '8px', marginBottom : '8px', marginLeft: '65px'}}>Verify to enable charge up front</Button>
                                        <Typography className="subtitle" style={{marginLeft: '65px'}}>
                                            New patrons will be charged the day they become a patron, then on the 1st of the month going forward.
                                        </Typography>
                                        <Link href="#" className="blue-link">Learn more</Link> 
                                        ...
                                        <RadioGroup
                                            ...
                                            name="radio-buttons-group"
                                        >
                                            <FormControlLabel value="are" control={<Radio disabled/>} label="Per Creation" />
                                            <div className="subtitle" style={{marginLeft: '30px', color: 'rgba(0, 0, 0, 0.38'}} disabled>Charge my patrons at the start of every month.</div>
                                            <div className="subtitle" style={{marginLeft: '30px'}} disabled>Your plan only supports a monthly payment schedule.</div>
                                        </RadioGroup>
                                    </Grid>
                                </Grid>
                            </Grid>
