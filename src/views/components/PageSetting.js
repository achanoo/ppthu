                        ...
                        <CardContent>
                            ...
                            <Grid item container >
                                    <Grid xs={12} sm={12} md={12}>
                                        ...
                                        <div className="subtitle">This account information will not appear on your public page.</div>
                                    </Grid>
                                </Grid>
                                <Grid item container >
                                    <Grid xs={4} sm={4} md={4}>
                            ...
                            <Grid container direction="row" spacing={3}>
                                <Grid item container >
                                    <Grid xs={4} sm={4} md={4}>
                                        ...
                                        <div className="subtitle">Choose the color visitors will see for links and buttons on your page.</div>
                                    </Grid>
                                    <Grid xs={8} sm={8} md={8}>
                                        <div className="subtitle">Suggested colors are based on your profile and cover photos. Choose any color—provided it’s dark enough to be legible—by clicking on the option with the pencil icon.</div>
                                    </Grid>
                                </Grid>
                            </Grid>
                        </CardContent>
                        ...
                        <CardContent>
                            <Grid container direction="row" spacing={3}>
                                <Grid item container>
                                    ...
                                    >
                                        <FormControlLabel value="is" control={<Radio sx={{ fontWeight : 'bold'}}/>} label="Public (recommended)" />
                                        <div className="subtitle" style={{marginLeft: '30px'}}>Anyone who visits your page will see how much you earn per month.</div>
                                        <FormControlLabel value="private" control={<Radio sx={{ fontWeight : 'bold'}}/>} label="Private" />
                                        <div className="subtitle" style={{marginLeft: '30px'}}>Only you can see how much you earn. Your earnings will be hidden from your page and goals.</div>
                                    </RadioGroup>
                                    </Grid>
                                </Grid>
                                <Grid item container>
                                    ...
                                    >
                                        <FormControlLabel value="is" control={<Radio sx={{ fontWeight : 'bold'}}/>} label="Public (recommended)" />
                                        <div className="subtitle" style={{marginLeft: '30px'}}>Anyone who visits your page will see how many patrons you have. We recommend this so that fans know there are others supporting you.</div>
                                        <FormControlLabel value="private" control={<Radio sx={{ fontWeight : 'bold'}}/>} label="Private" />
                                        <div className="subtitle" style={{marginLeft: '30px'}}>Only you can see how many patrons you have. The number of patrons you have will be hidden from your page and goals</div>
                                    </RadioGroup>
                                    </Grid>
                                </Grid>
                            </Grid>
                            ...
                            <Grid container direction="row" spacing={3}>
                                <Grid item container>
                                    <Grid xs={12} sm={12} md={12} centered>
                                        ...
                                        <div className="subtitle">Add your address if you want to display your location(s) on your public page and to appear in search results for local businesses.</div>
                                    </Grid>
                                </Grid>
                            </Grid>
                                        ...
                                        <Grid container direction="row" spacing={3}>
                                            <Grid item container>
                                                <Grid xs={12} sm={12} md={12} style={{textAlign: 'center'}}>
                                                    ...
                                                    <Button variant="contained" color="info" style={{borderRadius : '24px', padding : '8px', marginBottom : '8px'}}>Add a business address</Button>
                                                </Grid>
                                            </Grid>
                                        </Grid>
                                    </CardContent>
