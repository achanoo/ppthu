    ...
    <Box>
      ...
      <Grid container>
        <Grid
          ...
          <Typography>Language: English (United States)</Typography>
        </Grid>
        <Grid
          item
          xs={12}
      ...
      <Grid container>
        <Grid
          ...
          alignItems="center"
          className={classes.footerBorder}>
          <Typography>Myanmar (Burma)</Typography>
        </Grid>
        <Grid
          item
          xs={12}
    ...
    <Box>
      ...
      <Grid container>
        ...
        <Grid
          ...
          alignItems="center">
          <Typography className={classes.subTitle}>Privacy</Typography>
          <Typography className={classes.subTitle}>Term & Condition</Typography>
        </Grid>
      </Grid>
    </Box>
  );
